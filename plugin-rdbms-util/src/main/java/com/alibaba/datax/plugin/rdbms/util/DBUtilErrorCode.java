...
public enum DBUtilErrorCode implements ErrorCode {
    ...
    UNSUPPORTED_TYPE("DBUtilErrorCode-12", "不支持的数据库类型. 请注意查看 App 已经支持的数据库类型以及数据库版本."),
    ...
    ILLEGAL_SPLIT_PK("DBUtilErrorCode-04", "您填写的主键列不合法, App 仅支持切分主键为一个,并且类型为整数或者字符串类型."),
    SPLIT_FAILED_ILLEGAL_SQL("DBUtilErrorCode-15", "App尝试切分表时, 执行数据库 Sql 失败. 请检查您的配置 table/splitPk/where 并作出修改."),
